                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div id="post_select_image_container" class="post-select-image-container">
                            ...
                            <a id="btn_delete_post_main_image_database"
                                class="btn btn-danger btn-sm btn-delete-selected-file-image">
                ...
                <div class="modal-body">
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" class="dropzone" action="{{ route('admin.projects.upload') }}">
                                @csrf
