...
@section('content')
                ...
                <div class="modal-footer">
                    <div class="file-manager-footer">
                        <form action="{{ route('admin.projects.delete') }}">
                            <input class="form-control" readonly type="text" name="name" id="delete_name">
                            <input class="form-control" readonly type="text" name="did" id="delete_id">
                            <button type="submit" id="btn_img_delete" class="btn btn-danger pull-left btn-file-delete"
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#image_file_manager .file-box', function() {
            ...
            var d_name = $(this).attr('data-file-delete');
            var d_id = $(this).attr('data-file-delid');
        ...
        $(document).on('click', '#image_file_manager #btn_img_delete', function() {
            ...
            var file_name = $('#delete_name').val();
            var file_id = $('#delete_id').val();
            // alert(file_id)
            // $.ajax({
